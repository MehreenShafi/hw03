...
\begin{parts}
  ...
  \begin{solution}
    ...
    There are three possibilites for an anti-symmetric set,
    \begin{itemize}
    ...
    Thus, the condition of antisymmetric set becomes,
    ...
    Thus without refekxive relations the expression becomes,
...
\end{parts}
  ...
  \begin{solution}
    ...
    \part True. If both are symmetric, their intersection will also include the symmetric elements.
